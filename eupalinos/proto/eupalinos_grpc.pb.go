...
type EupalinosClient interface {
	...
	EnqueueMessageBytes(ctx context.Context, in *EpistelloBytes, opts ...grpc.CallOption) (*EnqueueResponse, error)
	// Unary RPC for epistello dequeueing
	DequeueMessage(ctx context.Context, in *ChannelInfo, opts ...grpc.CallOption) (*Epistello, error)
	DequeueMessageBytes(ctx context.Context, in *ChannelInfo, opts ...grpc.CallOption) (*EpistelloBytes, error)
...
func (c *eupalinosClient) EnqueueMessageBytes(ctx context.Context, in *EpistelloBytes, opts ...grpc.CallOption) (*EnqueueResponse, error) {
	out := new(EnqueueResponse)
	err := c.cc.Invoke(ctx, "/proto.Eupalinos/EnqueueMessageBytes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eupalinosClient) DequeueMessageBytes(ctx context.Context, in *ChannelInfo, opts ...grpc.CallOption) (*EpistelloBytes, error) {
	out := new(EpistelloBytes)
	err := c.cc.Invoke(ctx, "/proto.Eupalinos/DequeueMessageBytes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EupalinosServer interface {
	...
	EnqueueMessageBytes(context.Context, *EpistelloBytes) (*EnqueueResponse, error)
	// Unary RPC for epistello dequeueing
	DequeueMessage(context.Context, *ChannelInfo) (*Epistello, error)
	DequeueMessageBytes(context.Context, *ChannelInfo) (*EpistelloBytes, error)
	// Unary RPC for getting the length of the queue
...
func (UnimplementedEupalinosServer) EnqueueMessageBytes(context.Context, *EpistelloBytes) (*EnqueueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnqueueMessageBytes not implemented")
}
...
func (UnimplementedEupalinosServer) DequeueMessageBytes(context.Context, *ChannelInfo) (*EpistelloBytes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DequeueMessageBytes not implemented")
}
...
func _Eupalinos_EnqueueMessageBytes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EpistelloBytes)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EupalinosServer).EnqueueMessageBytes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Eupalinos/EnqueueMessageBytes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EupalinosServer).EnqueueMessageBytes(ctx, req.(*EpistelloBytes))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Eupalinos_DequeueMessageBytes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChannelInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EupalinosServer).DequeueMessageBytes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Eupalinos/DequeueMessageBytes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EupalinosServer).DequeueMessageBytes(ctx, req.(*ChannelInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Eupalinos_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EnqueueMessageBytes",
			Handler:    _Eupalinos_EnqueueMessageBytes_Handler,
		},
		{
		...
		{
			MethodName: "DequeueMessageBytes",
			Handler:    _Eupalinos_DequeueMessageBytes_Handler,
		},
		{
